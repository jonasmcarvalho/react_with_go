...
export default class AppClass extends Component {
  ...
  addPerson(newFirst, newLast, newDob) {
    let newPerson = {id: this.state.crowd.length + 1,
      firstName: newFirst,
      lastName: newLast,
      dob: newDob
    }
  ...
  render() {
    return (
      <>
        ...
        {this.state.isTrue &&
          <Fragment>
            <p>The current value of isTrue os true</p>
            <hr />
          </Fragment>
        }
        <hr />
        ...
        <hr />
        <a href="#!" className="btn btn-outline-secondary" onClick={this.toggleTrue}>Toglle isTrue</a>
